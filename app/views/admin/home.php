        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="well heading-text">
                       <p style="color:green"><?php echo Session::get("name");?></p>
                       <p>Welcome to phone list management web application</p> 
                    </div>                    
                </div>
            </div>
            ...
            <!-- ... Your content goes here ... -->
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12">
                      <div class="panel panel-default well panel-pad">
                          <!-- /.panel-heading -->
                          <div class="panel-body">
...
$('#button1').on('click', function(){
  ...
  $.ajax({
      type: 'ajax',
      method: 'POST',
      url: '<?php echo BASE_URL; ?>/Welcome/searchModal',
      data: {search:live},
      async: false,
      dataType: 'text',
      success: function(data){
